            ...
            <div class="w-100">
                <div class="w-100" >
                    <a data-bs-toggle="offcanvas" href="#offcanvasNav" role="button" aria-controls="offcanvasExample">
                        <img class="rounded-circle" height="35px" src="../img/icon-profile.png">
                    </a>
                </div>
...
<!-- Body/Tweets -->    
    <section class="section-main container p-0">
        ...
        <?php foreach($threadLine as $tweet) :?>
            <div class="tweet p-3">
        ...
        <!--<div class="modal show" id="modalTweet" tabindex="-1" aria-labelledby="modalTweetLabel" style="display: block;" aria-modal="true">-->
            <div class="modal-dialog modal-fullscreen-md-down">
                <div class="modal-content">
                    <form action="../controller/TwittearController.php" method="POST" >
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNav" aria-labelledby="offcanvasExampleLabel" aria-hidden="true">
  <div class="offcanvas-header d-flex flex-column align-items-start">
    <a class="me-2" href="../controller/ProfileController?id=<?= $user->getId()?>">
        <img class="rounded-circle" height="40px" src="../img/icon-profile.png">
    </a>
    <p class="mt-2 fw-bold"><?="@".$user->getUserName()?></p>
    <div class="following d-flex flex-row gap-2">
        <div id="follows"><p><span class="fw-bold"><?=count($user->getFollowingId())." "?></span>Siguiendo</p></div>
        <div id="followers"><p><span class="fw-bold"><?=count($user->getFollowersId())." "?></span>Seguidores</p></div>
    </div>
  </div>
  <div class="offcanvas-body p-0 align-items-start">
    ...
    <div class="dropdown mt-3">
      ...
      <ul class="dropdown-menu rounded-0 m-0 border-0 w-100">
        ...
        <li>
            <a class="dropdown-item mb-1 btn-nav d-flex flex-row align-items-center" href="../model/logout.php">
